...
curl -X POST -d '{"id":"1","name":"pool1","lb_method":"SLP","protocol":"tcp","vip_id":"1","timeout":30}' http://localhost:8080/quantum/v1.0/pools/
...
curl -X POST -d '{"id":"3","address":"10.0.0.6","port":"80","pool_id":"2"}' http://localhost:8080/quantum/v1.0/members/
curl -X POST -d '{"id":"4","address":"10.0.0.7","port":"80","pool_id":"2"}' http://localhost:8080/quantum/v1.0/members/